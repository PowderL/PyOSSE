"""
   ...
   Functions:
   ==============================================================
   1.  extract_region_flux: extract regional fluxes to 
   multi-layer maps 
...
def_flux_varnames=['longitude', 'latitude', 'map', 'flux', 'area']

# ##c: file name for single-layer flux 

def_fluxflnm='reg_flux_t3_05x05.nc'
...
def extract_region_flux(flux_flnm, \
    ...
    if (pid in varnames):
        ...
        lon, lat, reg_map, flux, area= ncfio.ncf_read(flux_flnm, varnames)
...
if (__name__=='__main__'):
    ...
    flux_flnm='reg_flux_t3_05x05.nc'
    out_ncflnm='reg_t3_ml.4x5.nc'
