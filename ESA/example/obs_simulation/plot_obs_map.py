...
import ESA.util.gen_plots as gpl2
...
stitle='GOSAT XCO2 in June, 2009'

gpl.plot_map(ma_obs, rlon=xx, rlat=yy, maxv=maxv, minv=minv,dv=dv,use_pcolor=1, cmap=cx, title=stitle)
...
gpl2.plot_map(count_clear, rlon=xx, rlat=yy, use_pcolor=1, title=stitle)

# stitle='posterior'
savefig('posterior_cmp_obs_map_200906.png')
show()
