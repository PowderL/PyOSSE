...
class descfile_desc_cl:
    ...
    def translate_column_names(self, colnm_lst, **keywords):
        """
    ...
    def append_data(self, flnm, data, ref, head=[]):
        """
    ...
    def del_data(self, idx, by_ref=False):
        ...
        del self.head_lst[idx]
        
        self.nset=self.nset-1
        
        return self.nset
    
    def locate_section(self, lines, marker='#C'):
    ...
    def read_table_from_lines(self, lines, colnm_lst, colno_lst,\
        ...
        dtable=lnpm.read_table_from_lines(lines, colnm_lst, colno_lst,\
...
if (__name__=='__main__'):
    ...
    print 'For test, see ESA/surface/flux_desc_file_io_m.py'
